...
export const ProductsStatusSummary = memo(function ProductsStatusSummary({
  ...
  return (
    <Card className="bg-gradient-to-br from-orange-100 to-amber-50 dark:from-gray-900 dark:to-gray-900 border border-orange-200/70 dark:border-orange-500/20 shadow-md md:hover:shadow-lg md:transition-shadow md:duration-150">
