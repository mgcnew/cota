...
export const ProductsHeroCard = memo(function ProductsHeroCard({
  ...
  return (
    <Card className="relative overflow-hidden border border-orange-200/70 dark:border-orange-500/20 bg-orange-50/50 dark:bg-gray-900 shadow-md md:hover:shadow-lg md:transition-shadow md:duration-150">
