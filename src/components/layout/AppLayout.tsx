...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 via-slate-50 to-stone-50 dark:from-gray-900 dark:via-gray-950 dark:to-slate-950 overflow-x-hidden">
      ...
      <div className="flex flex-col w-full min-h-screen relative">
        ...
        <header className="fixed top-1 right-1 left-1 md:left-[6rem] z-40 h-12 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200/60 dark:border-gray-700/60 hover:border-gray-300/70 dark:hover:border-gray-600/70 rounded-xl transition-all duration-500 ease-out">
        ...
        {/* Main Content */}
        <main className="flex-1 w-full overflow-x-hidden pb-20 md:pb-0 relative pt-16 pl-0 md:pl-[5.5rem] pr-1">
