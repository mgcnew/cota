      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-zinc-500 dark:text-zinc-400 font-medium">
              <li><Link to="/auth?mode=login" className="hover:text-[#83E509] transition-colors">Entrar no Sistema</Link></li>
              <li><Link to="/auth?mode=login" className="hover:text-[#83E509] transition-colors">Suporte Interno</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-zinc-500 dark:text-zinc-400 font-medium">
              <li><a href="#" className="hover:text-[#83E509] transition-colors">Privacidade</a></li>
              <li><a href="#" className="hover:text-[#83E509] transition-colors">Termos de Uso</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-zinc-100 dark:border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-4 text-zinc-400 text-sm font-medium">
          ...
          <div className="flex gap-6">
            <span className="text-[#83E509] font-bold">● V.2.0.0</span>
          </div>
        </div>
      </div>
    </footer>
