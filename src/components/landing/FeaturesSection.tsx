...
const features = [
  {
    icon: <Package className="h-6 w-6 text-[#83E509]" />,
  ...
  {
    icon: <Building2 className="h-6 w-6 text-[#83E509]" />,
  ...
  {
    icon: <FileText className="h-6 w-6 text-[#83E509]" />,
  ...
  {
    icon: <TrendingUp className="h-6 w-6 text-[#83E509]" />,
  ...
  {
    icon: <BarChart3 className="h-6 w-6 text-[#83E509]" />,
  ...
  {
    icon: <Zap className="h-6 w-6 text-[#83E509]" />,
    ...
    <section className="container mx-auto px-4 py-20 sm:py-32">
      <div className="text-center mb-16 sm:mb-24">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-6">
          Plataforma <span className="text-[#83E509]">Full-Stack</span> para Compras
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        {features.map((feature, index) => (
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#83E509]/5 blur-[60px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>

            <div className="w-12 h-12 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 flex items-center justify-center group-hover:bg-[#83E509]/10 transition-colors">
              {feature.icon}
            </div>
