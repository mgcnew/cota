  ...
  return (
    <div style={style} className="px-2 py-1">
      <div className={cn(
        ...
        isBestPrice ? "border-emerald-200 dark:border-emerald-800/50 bg-emerald-50 dark:bg-emerald-900/10" : "border-gray-100 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 hover:shadow-md",
...
export function QuoteValuesTab({
  ...
  return (
    <div className="flex flex-col md:flex-row h-full relative">
      ...
      <div className={cn(
        "w-full md:w-48 xl:w-56 flex-col border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 transition-all duration-300 z-20",
        ...
        <div className="p-2 border-b border-gray-200 dark:border-gray-800 relative z-10 space-y-2">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 rounded-lg bg-white dark:bg-gray-800 flex items-center justify-center text-gray-600 border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              className="h-7 pl-7 text-[10px] bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-lg focus-visible:ring-1 focus-visible:ring-gray-300 dark:focus-visible:ring-gray-600" 
            />
          </div>
        </div>
                ...
                return (
                  <button 
                    ...
                    className={cn(
                      ...
                      isSelected 
                        ? "bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700" 
      ...
      <div className={cn(
        "flex-1 flex-col bg-white dark:bg-gray-950 relative overflow-hidden z-10",
        isMobile && !showMobileValues ? "hidden" : "flex"
      )}>
        
        {/* Mobile Back Header */}
        {isMobile && (
          <div className="flex items-center gap-2 p-2 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
        ...
        {selectedSupplier ? (
          <>
            ...
            <div className="flex-shrink-0 px-3 py-2 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 flex items-center justify-between gap-3 relative z-10">
            ...
            <div className="flex-1 flex flex-col relative z-10 overflow-hidden">
              <div className="grid grid-cols-[1.5fr_0.8fr_1.2fr_auto] gap-2 px-3 py-1.5 border-b border-gray-200 dark:border-gray-800 text-[8px] font-black uppercase text-gray-500 tracking-[0.2em] bg-gray-50 dark:bg-gray-900 flex-shrink-0">
                 <div>Produto</div>
          ...
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="text-center animate-in fade-in zoom-in-95 duration-700 max-w-sm">
              <div className="w-16 h-16 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center mx-auto mb-3 shadow-sm group hover:scale-110 transition-transform">
