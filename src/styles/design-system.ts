...
export const designSystem = {
    ...
    layout: {
        ...
        container: {
            ...
            page: "container mx-auto px-4 pt-4 pb-6 md:pt-4 md:pb-8 max-w-7xl space-y-4",
            section: "space-y-4",
    ...
    components: {
        ...
        card: {
            root: "bg-card border border-border rounded-xl shadow-[0_2px_12px_-4px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_20px_-6px_rgba(0,0,0,0.12)] hover:border-border/80 transition-all duration-200",
            ...
            body: "p-4",
            footer: "px-4 py-3 bg-muted/30 dark:bg-card/50 border-t border-border rounded-b-xl text-xs text-muted-foreground"
        },
        ...
        modal: {
            ...
            content: "relative z-50 w-full max-w-2xl bg-card border border-border shadow-2xl rounded-xl p-0 animate-fade-in flex flex-col max-h-[90vh]",
            header: "flex-shrink-0 flex items-center justify-between px-4 py-3 border-b border-border bg-transparent rounded-t-xl",
            title: "text-sm font-semibold leading-none tracking-tight text-foreground",
            body: "p-4 overflow-y-auto flex-1 custom-scrollbar",
            footer: "flex-shrink-0 flex items-center justify-end gap-2 px-4 py-3 bg-muted/30 dark:bg-card/50 border-t border-border rounded-b-xl",
        ...
        table: {
            ...
            headerWrapper: "flex items-center rounded-lg shadow-[0_2px_8px_-2px_rgba(0,0,0,0.04)] px-4 py-3 border bg-card mb-2",
            row: "bg-card border border-border shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] rounded-xl overflow-hidden transition-all duration-200 hover:shadow-[0_4px_12px_-4px_rgba(0,0,0,0.08)] hover:scale-[1.002] mb-1.5",
            ...
            headerContainer: "flex items-center shadow-[0_2px_8px_-2px_rgba(0,0,0,0.04)] px-4 py-4 border bg-card rounded-xl mb-2",
        ...
        separator: {
            horizontal: "h-[1px] w-full bg-border my-4",
            vertical: "h-full w-[1px] bg-border mx-4"
        },
