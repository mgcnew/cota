                    ...
                    return (
                      <TableRow key={cotacao.id} className="group border-none">
                        <TableCell colSpan={7} className="px-1 py-3">
                          <div className="flex items-center px-1.5 py-2 bg-white/90 dark:bg-gray-800 rounded-lg border border-gray-300/70 dark:border-gray-700 hover:shadow-md hover:border-teal-300/60 dark:hover:border-teal-500/50 transition-all">
